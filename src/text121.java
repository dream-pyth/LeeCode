 ...
 * <p>示例 1：
 *
 * <p>输入：[7,1,5,3,6,4] 输出：5 解释：在第 2 天（股票价格 = 1）的时候买入，在第 5 天（股票价格 = 6）的时候卖出，最大利润 = 6-1 = 5 。 注意利润不能是
 ...
 * <p>提示：
 *
 * <p>1 <= prices.length <= 10^5 0 <= prices[i] <= 10^4
 */
public class text121 {
    ...
    //    /**
    //     * 采用遍历,用i，j记录买入和卖出的位置(双重for循环效率很低)
    //     *
    //     * @param prices
    //     * @return
    //     */
